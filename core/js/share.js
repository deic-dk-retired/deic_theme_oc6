OC.Share={
	...
	share:function(itemType, itemSource, shareType, shareWith, permissions, itemSourceName, callback, token) {
		/*$.post(OC.filePath('core', 'ajax', 'share.php'),*/
		$.post('/themes/deic/core/ajax/share.php',
					 {
				action: 'share',
				itemType: itemType,
...
//							}
	...
	sharingDialogAllowPublicUpload:function(){
		// Gather data
		var itemType = $('#dropdown').data('item-type');
		var itemSource = $('#dropdown').data('item-source');
		var itemSourceName = $('#dropdown').data('item-source-name');
...
$(document).ready(function() {
	...
	//$(document).on('focusout keyup', '#dropdown #linkText', function(event) {
	$(document).on('focusout', '#dropdown #linkText', function(event) {
		//alert("ok");
		OC.Share.setLink();
	});
	...
	$(document).on('click', '#sharingDialogAllowPublicUpload', function() {
		OC.Share.sharingDialogAllowPublicUpload();
	});

	$(document).on('click', '#dropdown #showPassword', function() {
		OC.Share.showPassword();
	});
