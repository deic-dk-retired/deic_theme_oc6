...
var createDragShadow = function(event) {
	...
	$(selectedFiles).each(function(i,elem) {
		...
		tbody.append(newtr);
		if (elem.type === 'dir') {
			newtr.find('td.filename').attr('style','background-image:url('+OC.imagePath('/themes/deic/core', 'filetypes/folder.png')+')');
			//newtr.find('td.filename').attr('style','background-image:url(/themes/deic/core/img/filetypes/folder.png)+')');
		} else {
