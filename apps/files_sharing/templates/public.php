...
<header><div id="header" class="icon icon-noise <?php p((isset($_['folder']) ? 'share-folder' : 'share-file')) ?>">
		<a href="<?php print_unescaped(link_to('', 'index.php')); ?>" title="" id="logo"><img class="svg"
		                                                                                          src="<?php print_unescaped(image_path('', 'logo-green-gray.svg')); ?>" alt="DeIC" /></a>
		<div class="header-right">
			<span id="details"><?php p($l->t('Shared by %s', array($_['displayName']))) ?>. &nbsp;&nbsp;&nbsp;&nbsp;To share data - just <a href='https://data.deic.dk/'>log in</a>.</span>
		</div>
</div></header>
<div id="content">
	<div id="preview">
